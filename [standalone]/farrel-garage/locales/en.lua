Locales['en'] = {
	...
	['press_to_enter'] = 'Press [E] to take Vehicle out of Garage.',
	['press_to_delete'] = 'Press [E] to store Vehicle in the Garage.',
	['press_to_impound'] = 'Press [E] to access the Impound.',
	['you_paid'] = 'You paid $',
